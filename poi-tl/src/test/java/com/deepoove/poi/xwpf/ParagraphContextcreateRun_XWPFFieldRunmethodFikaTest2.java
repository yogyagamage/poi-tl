...
class ParagraphContextcreateRun_XWPFFieldRunmethodFikaTest2 {

    @Test
    void testCreateRunInvokesXWPFFieldRunConstructor() throws Exception {
        XWPFParagraphWrapper paragraphWrapper = Mockito.mock(XWPFParagraphWrapper.class);
